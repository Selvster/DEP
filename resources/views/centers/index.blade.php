<x-app-layout>
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">المراكز</h1>
                <p class="text-gray-600 mt-1">إدارة المراكز</p>
            </div>
            @can('create_center')
            <a href="{{ route('centers.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6">
            <table id="centers-table" class="w-full">
                <thead>
                    <tr>
