<x-app-layout>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">إدارة حسابات المستخدمين في النظام</p>
        </div>
        @can('create_user')
    ...
    <script>
        $(document).ready(function() {
            ...
            console.log('Window datatableConfig:', window.datatableConfig);
            console.log('Table element found:', $('#users-table').length);
