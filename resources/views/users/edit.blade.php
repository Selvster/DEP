<x-app-layout>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">تعديل بيانات المستخدم: {{ $user->name }}</p>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-6">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">كلمة المرور الجديدة (اتركها فارغة للحفاظ على كلمة المرور الحالية)</label>
                <input type="password" 
                       name="password" 
                       id="password"
